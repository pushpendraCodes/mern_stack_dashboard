        ...
        <div class="modal-dialog relative w-auto pointer-events-none">
          <div
            ...
            <div
              ...
              <h5 style={{ color: 'rgb(229, 57, 53)' }} class="text-xl  leading-normal  block uppercase tracking-wide text-gray-700 text-xs font-bold " id="exampleModalLabel">SubAdmin Details</h5>
              <button type="button"
              ...
              <form >
                ...
                {/* <div class="w-full  px-3">
                  ...
                  <input
                    ...
                    onChange={validation.handleChange}
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" placeholder="Phone" />
