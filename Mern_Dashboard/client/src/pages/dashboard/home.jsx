...
let navigate = useNavigate()
  ...
  const getadmin = async () => {
    let res = await axios.get("https://voicechat.online:4000/list/admin", {
      headers: {
        'Content-Type': 'application/json',
        'authorization': JSON.parse(localStorage.getItem("user"))
      },
  ...
  // const { Admindata: Data1 } = useSelector((state) => state.admins)
  //  console.log("admin", Data1)

  // const { SubAdmindata: Data2 } = useSelector((state) => state.subadmins)
  //  console.log("subadmin", Data2)

  // const { Clientdata: Data3 } = useSelector((state) => state.clients)
  //  console.log("client", Data3)

  useEffect(() => {
    // chat_invitation()
    // dispatch(fetch_Admin())
    // setadmin(Data1.length)
    // dispatch(fetch_SubAdmin())
    // setsubadmin(Data2.length)
    // dispatch(fetch_Client())
    // setclient(Data3.length)
