        ...
        <tr key={name}>
         ...
         <td className="border-b border-blue-gray-50 py-3 px-5 ">
            ...
            <td className="border-b border-blue-gray-50 py-3 px-5 " style={{display:'flex'}}>
                ...
                <Typography> <Link to={`/dashboard/client/${_id}`}><GrView style={{width: "59px",
fontSize: '21px'}}  /></Link></Typography>
            </td>
            <td className="border-b border-blue-gray-50 py-3 px-5 ">
            ...
            <td style={{ display: 'flex' }} className="border-b border-blue-gray-50 py-3 px-5 ">
                ...
                <button data-bs-toggle="modal" data-bs-target="#puspe" onClick={() => { props.update(_id) }} class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-1 px-2 rounded mx-2">
                    <BiEdit />
                </button>
                <button onClick={() => { props.delete(_id) }} class="bg-red-500 hover:bg-blue-800 text-white font-bold py-1 px-2 rounded">
                    <AiFillDelete />
                </button>
